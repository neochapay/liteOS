...
public class OscopeMsg extends tools.message.Message {
	...
	/**
	 * Create a new OscopeMsg with the given data_length and base offset.
	 */
	...
	/**
	 * Create a new OscopeMsg using the given byte array as backing store.
	 */
	...
	/**
	 * Create a new OscopeMsg using the given byte array as backing store, with
	...
	/**
	 * Create a new OscopeMsg embedded in the given message at the given base
	 * offset.
	 */
	...
	public String toString() {
		...
		try {
			s += "  [lastSampleNumber=0x"
					+ Long.toHexString(get_lastSampleNumber()) + "]\n";
		} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
		}
		try {
